...
namespace PixelCrushers.DialogueSystem {
	...
	/// </summary>
	public class SmartTypeWriter : MonoBehaviour {
		...
		public IEnumerator Play() {
			...
			IsPlaying = false;
			//Check to confirm whether we're showing an input or not, and display the input accordingly if we are.
			CheckInput ();
		}
		...
		public void Stop() {
			...
			//Do another check for inputs here
			CheckInput ();
		}

...
struct  ThreadSafeDictionary_2_t4922  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t4921 * ____valueFactory_1;
	...
	Dictionary_2_t9713 * ____dictionary_2;
};

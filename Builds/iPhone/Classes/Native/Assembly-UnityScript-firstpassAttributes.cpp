...
void SmoothFollow_t705_CustomAttributesCacheGenerator(CustomAttributesCache* cache)
{
	static bool s_Il2CppMethodIntialized;
	if (!s_Il2CppMethodIntialized)
	{
	...
	cache->attributes = (Il2CppObject**)il2cpp_gc_alloc_fixed(sizeof(Object_t *) * cache->count, 0);
	{
		...
		AddComponentMenu__ctor_m3314(tmp, il2cpp_codegen_string_new_wrapper("Camera-Control/Smooth Follow"), NULL);
		cache->attributes[0] = (Il2CppObject*)tmp;
	}
}
extern const CustomAttributesCacheGenerator g_AssemblyU2DUnityScriptU2Dfirstpass_Assembly_AttributeGenerators[3] = 
{
	...
	SmoothFollow_t705_CustomAttributesCacheGenerator,
};

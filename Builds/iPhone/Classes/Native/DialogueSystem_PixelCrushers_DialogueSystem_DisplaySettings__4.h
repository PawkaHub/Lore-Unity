...
struct  AlertSettings_t919  : public Object_t
{
	...
	// System.Single PixelCrushers.DialogueSystem.DisplaySettings/AlertSettings::alertCheckFrequency
	float ___alertCheckFrequency_1;
};

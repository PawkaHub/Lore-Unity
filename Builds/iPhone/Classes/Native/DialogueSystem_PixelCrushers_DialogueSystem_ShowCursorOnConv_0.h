...
struct  ShowCursorOnConversation_t986  : public MonoBehaviour_t47
{
	// System.Boolean PixelCrushers.DialogueSystem.ShowCursorOnConversation::wasCursorVisible
	bool ___wasCursorVisible_2;
	// UnityEngine.CursorLockMode PixelCrushers.DialogueSystem.ShowCursorOnConversation::savedLockState
	int32_t ___savedLockState_3;
};

...
struct  ClientSessionInfo_t4604  : public Object_t
{
	...
	DateTime_t1953  ___validuntil_2;
	...
	ByteU5BU5D_t25* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t25* ___masterSecret_5;
};
struct ClientSessionInfo_t4604_StaticFields{

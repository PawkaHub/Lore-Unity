...
struct  SslStreamBase_t3992  : public Stream_t1494
{
	...
	ManualResetEvent_t3076 * ___negotiationComplete_13;
	...
	MemoryStream_t576 * ___recordStream_15;
};
struct SslStreamBase_t3992_StaticFields{
	// System.Threading.ManualResetEvent Mono.Security.Protocol.Tls.SslStreamBase::record_processing
	ManualResetEvent_t3076 * ___record_processing_2;
};

...
struct  SslStreamBase_t1285  : public Stream_t1271
{
	...
	ManualResetEvent_t1270 * ___negotiationComplete_13;
	...
	MemoryStream_t558 * ___recordStream_15;
};
struct SslStreamBase_t1285_StaticFields{
	// System.Threading.ManualResetEvent Mono.Security.Protocol.Tls.SslStreamBase::record_processing
	ManualResetEvent_t1270 * ___record_processing_2;
};

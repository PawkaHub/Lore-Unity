...
struct  SetAnimationAction_t1294  : public Action_t1279
{
	...
	// UnityEngine.AnimationClip PixelCrushers.DialogueSystem.SetAnimationOnDialogueEvent/SetAnimationAction::animationClip
	AnimationClip_t296 * ___animationClip_2;
};

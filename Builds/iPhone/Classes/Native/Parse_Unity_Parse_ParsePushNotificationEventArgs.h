...
struct  ParsePushNotificationEventArgs_t1879  : public EventArgs_t1461
{
	...
	// System.String Parse.ParsePushNotificationEventArgs::<StringPayload>k__BackingField
	String_t* ___U3CStringPayloadU3Ek__BackingField_2;
};

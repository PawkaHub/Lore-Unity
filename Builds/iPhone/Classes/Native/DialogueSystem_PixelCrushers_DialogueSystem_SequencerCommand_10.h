...
struct  SequencerCommandDelay_t1486  : public SequencerCommand_t209
{
	// System.Single PixelCrushers.DialogueSystem.SequencerCommands.SequencerCommandDelay::stopTime
	float ___stopTime_6;
};
